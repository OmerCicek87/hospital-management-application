        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PWZNumber = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DutyDate = table.Column<DateTime>(type: "datetime(6)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DutyReports", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DutyReports_Duties_DutyId",
                        column: x => x.DutyId,
                        principalTable: "Duties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DutyReports_Employees_ReportingEmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DutyReports_DutyId",
                table: "DutyReports",
                column: "DutyId");

            migrationBuilder.CreateIndex(
                name: "IX_DutyReports_ReportingEmployeeId",
                table: "DutyReports",
